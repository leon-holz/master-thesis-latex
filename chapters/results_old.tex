...
For the pipeline we evaluated the results again for only the subset of sbreddits that we were going to post too. This had a negligibly impact with only small changes to performance that didnt chance the larger picture of what inputs and configurations were best used

% todo further results are not available yet
